...
public class Main {
	...
	public static void main(String[] args) {
		...
		// have no quarter
		gumballMachine1.insertQuarter(10, 10, 0, 0);
		gumballMachine1.turnCrank();
		// have quarter
		gumballMachine1.insertQuarter(10, 10, 0, 1);
		gumballMachine1.turnCrank();
		System.out.println(gumballMachine1);
		...
		//have no quarter
		gumballMachine2.insertQuarter(10, 10, 0, 0);
		gumballMachine2.turnCrank();
		// don't have enough quarters
		gumballMachine2.insertQuarter(10, 10, 0, 1);
		gumballMachine2.turnCrank();
		// have enough quarter
		gumballMachine2.insertQuarter(10, 10, 2, 2);
		gumballMachine2.turnCrank();
		gumballMachine2.insertQuarter(10, 10, 2, 2);
		gumballMachine2.turnCrank();
		System.out.println(gumballMachine2);
		...
		// don't have enough cpins
		gumballMachine3.insertQuarter(10, 0, 0, 0);
		gumballMachine3.turnCrank();
		// have enough quarter
		gumballMachine3.insertQuarter(10, 10, 5, 5);
		gumballMachine3.turnCrank();
		gumballMachine3.insertQuarter(10, 10, 5, 5);
		gumballMachine3.turnCrank();
		System.out.println(gumballMachine3);
