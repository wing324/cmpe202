...
public class NoQuarterState implements State {
    ...
    {
      // this.total_coin > 25
        if ((gumballMachine.getTypeGumballMachine() == 1 && total_quarters >= 25)||(gumballMachine.getTypeGumballMachine() == 2 && total_quarters >= 50)||(gumballMachine.getTypeGumballMachine() == 3 && total_coins >= 50))
        {
